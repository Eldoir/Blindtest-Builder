...
* To make my life easier, the folders below are ignored. This allows me to have my source files close to the code to keep short paths and everything is in the same place. You can do the same!
  * _assets/_: I put my _intro_, _outro_, and _transition_ files here, as well as some editing files, like an Adobe Premiere Pro project, and also a text file containing the rules of my blind tests, and some notes, whatever.
  * _clips/_: I put my audio and video files here.
  * _output/_: I put the output files of the program here.
