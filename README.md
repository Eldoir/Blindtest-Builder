...
# Next steps
* Prepare a default folder (and ignore current config.json specific to my blind test)
* When answered 'No' to overwrite, should not log and error, nor log the "Video created"
